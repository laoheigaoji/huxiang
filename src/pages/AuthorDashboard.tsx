    ...
    const fetchData = async () => {
      try {
        ...
        if (err.message === '未登录') {
          ...
          // Stay on page but potentially show error
          // For now, let's just log and maybe show a toast if we had one
          // We'll keep the navigate('/login') for now but added a check
