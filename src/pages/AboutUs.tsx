...
const AboutUs = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#e53935] px-4 py-4 flex items-center justify-center relative shadow-sm header-safe-area">
      ...
      <div className="flex flex-col items-center mt-12 bg-white py-12 shadow-sm">
        <div className="w-20 h-20 bg-[#e53935] rounded-2xl flex items-center justify-center shadow-lg mb-4">
